...
unsigned char sound(unsigned char nChannelStatus, int nTonePeriod, int 
nDuration, unsigned char nVolume, char nVolumeEnvelope, char 
...
main()
{
  int aSounds[12] = { 478, 451, 426, 402, 379, 358, 338, 319, 301, 284, 
268, 253 };
  int n = 0;
